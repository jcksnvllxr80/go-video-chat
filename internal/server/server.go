...
var (
	addr = flag.String("addr", ":"+os.Getenv("PORT"), os.Getenv("PORT"), "")
...
func Run() error {
	...
	app.Get("/room/:uuid/websocket", websocket.New(handlers.RoomWebsocket, wesocket.Config {
		HandshakeTimeout: 10*time.Second,
	}))
	app.Get("/room/:uuid/chat", handler.RoomChat)
	app.Get("/room/:uuid/chat/websocket", webcoket.New(handlers.RoomChatWebsocket))
